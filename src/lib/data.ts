...
export const savedStories = [
  {
    ...
    title: 'Midnight Bloom',
    artist: 'Luna Haze',
    generatedCoverUrl: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=500&h=890&q=80',
  },
  {
    id: 's2',
    title: 'Neon Rush',
    artist: 'SynthWave Surfers',
    generatedCoverUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=500&h=890&q=80',
  },
  {
    id: 's3',
    title: 'Golden Hour',
    artist: 'The Daydreamers',
    generatedCoverUrl: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=500&h=890&q=80',
  },
  {
    id: 's4',
    title: 'Fading Embers',
...
export function convertSpotifyToVibelyTrack(
  ...
  return {
    ...
    originalCoverUrl: spotifyTrack.album.images[0]?.url || 'https://picsum.photos/seed/default/500/500',
