...
export const metadata: Metadata = {
  ...
  description: "Transform your music with personalized AI-generated album covers using your photos and mood analysis. Create stunning visuals that match your vibe.",
  keywords: ["AI", "album cover", "music", "photo", "generator", "artwork", "design", "spotify", "apple music"],
  ...
  openGraph: {
    ...
    url: '/',
    title: 'Vibely - AI Album Art Generator',
    description: 'Transform your music with personalized AI-generated album covers using your photos and mood analysis.',
    siteName: 'Vibely',
    images: [
      {
        url: '/og-image.png',
