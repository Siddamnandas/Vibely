...
export default function AuthPage() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            toast({ variant: "default", className: "bg-green-500 text-white", title: "Login Successful!", description: "Welcome back!" });
    ...
    const handleSignup = async () => {
        ...
        try {
            ...
            toast({ variant: "default", className: "bg-green-500 text-white", title: "Signup Successful!", description: "Your account has been created." });
                ...
                <TabsContent value="login">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Access your account to continue generating album art.</CardDescription>
                        </CardHeader>
