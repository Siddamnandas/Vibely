          ...
          >
            ...
            <div className="relative w-full h-full">
              ...
              <div className={`absolute inset-0 mix-blend-multiply opacity-20 ${
                index % 3 === 0 ? 'bg-gradient-to-br from-[#9FFFA2]/40 to-transparent' :
                index % 3 === 1 ? 'bg-gradient-to-br from-[#FF6F91]/40 to-transparent' :
...
export default function LibraryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0E0F12] text-white">
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {songs.map((song) => (
                <Card key={song.id} className="overflow-hidden bg-white/5 border border-white/10 shadow-lg hover:bg-white/10 transition-colors duration-300 rounded-3xl">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-grow overflow-hidden">
                        ...
                        <Badge variant="outline" className="mt-2 text-xs border-accent text-accent">{song.mood}</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      {openPlaylistId && (
        <PlaylistDetailOverlay playlistId={openPlaylistId} onClose={() => setOpenPlaylistId(null)} />
      )}
    </div>
  );
}
