...
const mockGeneratedCovers = [
  {
    ...
    template: {
      ...
      layout: { titlePosition: { x: 0.1, y: 0.1 }, artistPosition: { x: 0.1, y: 0.9 }, imageArea: { x: 0, y: 0, width: 1, height: 1 } },
      textStyles: {
        titleFont: 'Inter', titleSize: 32, titleColor: '#FFFFFF', titleWeight: 'bold' as const,
        artistFont: 'Inter', artistSize: 18, artistColor: '#CCCCCC', artistWeight: 'normal' as const
      },
      effects: { hasGradient: true, gradientColors: ['#9FFFA2', '#FF6F91'] as [string, string], hasOverlay: true, overlayColor: '#000000', overlayOpacity: 0.4, hasBlur: false }
    },
